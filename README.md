...
![Image Compare with a PNG and a PDF side by side: previews on a transparency checkerboard, metadata tables with the differing rows highlighted, similarity scores, and a red difference map](screenshots/screenshots/png image compare.png.png)

![Image Compare with two PDFs side by side: previews, metadata tables, the pixel and perceptual similarity scores, and the difference map](screenshots/screenshots/pdf image compare.png.png)
